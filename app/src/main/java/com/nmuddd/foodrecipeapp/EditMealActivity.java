...
public class EditMealActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editRecipe = findViewById(R.id.edit_recipe_btn);
        ...
        Intent intentFromDetailPersonal = getIntent();
        meal = (Meal) intentFromDetailPersonal.getSerializableExtra(DetailPersonalActivity.EXTRA_EDIT_MEAL);
    ...
    private void bindingDataToUI() {
        ...
        try {
            addEditTextIngredientToLayout(meal.getStrIngredient1());
            addEditTextIngredientToLayout(meal.getStrIngredient2());
            addEditTextIngredientToLayout(meal.getStrIngredient3());
            addEditTextIngredientToLayout(meal.getStrIngredient4());
            addEditTextIngredientToLayout(meal.getStrIngredient5());
            addEditTextIngredientToLayout(meal.getStrIngredient6());
            addEditTextIngredientToLayout(meal.getStrIngredient7());
            addEditTextIngredientToLayout(meal.getStrIngredient8());
            addEditTextIngredientToLayout(meal.getStrIngredient9());
            addEditTextIngredientToLayout(meal.getStrIngredient10());
            addEditTextIngredientToLayout(meal.getStrIngredient11());
            addEditTextIngredientToLayout(meal.getStrIngredient12());
            addEditTextIngredientToLayout(meal.getStrIngredient13());
            addEditTextIngredientToLayout(meal.getStrIngredient14());
            addEditTextIngredientToLayout(meal.getStrIngredient15());
            addEditTextIngredientToLayout(meal.getStrIngredient16());
            addEditTextIngredientToLayout(meal.getStrIngredient17());
            addEditTextIngredientToLayout(meal.getStrIngredient18());
            addEditTextIngredientToLayout(meal.getStrIngredient19());
            addEditTextIngredientToLayout(meal.getStrIngredient20());
        } catch (Exception e) {

        }

        try {
            addEditTextMeasureToLayout(meal.getStrMeasure1());
            addEditTextMeasureToLayout(meal.getStrMeasure2());
            addEditTextMeasureToLayout(meal.getStrMeasure3());
            addEditTextMeasureToLayout(meal.getStrMeasure4());
            addEditTextMeasureToLayout(meal.getStrMeasure5());
            addEditTextMeasureToLayout(meal.getStrMeasure6());
            addEditTextMeasureToLayout(meal.getStrMeasure7());
            addEditTextMeasureToLayout(meal.getStrMeasure8());
            addEditTextMeasureToLayout(meal.getStrMeasure9());
            addEditTextMeasureToLayout(meal.getStrMeasure10());
            addEditTextMeasureToLayout(meal.getStrMeasure11());
            addEditTextMeasureToLayout(meal.getStrMeasure12());
            addEditTextMeasureToLayout(meal.getStrMeasure13());
            addEditTextMeasureToLayout(meal.getStrMeasure14());
            addEditTextMeasureToLayout(meal.getStrMeasure15());
            addEditTextMeasureToLayout(meal.getStrMeasure16());
            addEditTextMeasureToLayout(meal.getStrMeasure17());
            addEditTextMeasureToLayout(meal.getStrMeasure18());
            addEditTextMeasureToLayout(meal.getStrMeasure19());
            addEditTextMeasureToLayout(meal.getStrMeasure20());
        } catch (Exception e) {
    ...
    private void addEditTextMeasureToLayout(String measure) {
        EditText editTextMeasure = new EditText(this);
        editTextMeasure.setHint("Enter measure: ");
        editTextMeasure.setText(measure);
    ...
    private void addEditTextIngredientToLayout(String ingredient) {
        EditText editTextIngredient = new EditText(this);
        editTextIngredient.setHint("Enter ingredient: ");
    ...
    private void deleteEmptyItem() {
        int listSize = listIngredientItemET.size();
    ...
    private void updateMyMealAndImageToFirebase() {
        String oldIDMeal = meal.getIdMeal();
        deleteOldImage(oldIDMeal);
        uploadImageToStorageAndDatabase();
    }

    private void deleteOldImage(String oldIDUser) {
        StorageReference storageReference = firebaseStorageInstance.firebaseStorage
                .child(FirebaseStorageInstance.STORAGE_PATH_UPLOADS + CurrentUser.idUser + oldIDUser + "." + getFileExtension(filePath));
        storageReference.delete().addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(getApplicationContext(), "Upload error", Toast.LENGTH_SHORT);
            }
        });
    }
    ...
    private void uploadImageToStorageAndDatabase() {
        if (filePath != null) {
            ...
            StorageReference storageReference = firebaseStorageInstance.firebaseStorage
                    .child(FirebaseStorageInstance.STORAGE_PATH_UPLOADS + CurrentUser.idUser + meal.getIdMeal() + "." + getFileExtension(filePath));
                                        ...
                                        public void onDataChange(@NonNull DataSnapshot snapshot) {
                                            if (snapshot.exists()) {
                                                ...
                                                for (DataSnapshot userSnapshot : snapshot.getChildren()) {
                                                    mealTemp = createMeal(uri, meal.getIdMeal());
                                                    userSnapshot.getRef().setValue(setUser(mealTemp));
                                                }
                                                Intent intent = new Intent(getApplicationContext(), DetailPersonalActivity.class);
                                                intent.putExtra(DetailPersonalActivity.EXTRA_DETAIL_PERSONAL, (Serializable) mealTemp);
    ...
    private User setUser(Meal meal1) {
        User user = new User();
